...
<!--<form method="POST" enctype="multipart/form-data">-->
    ...
    function getWifiIcon($quality) {
      ...
      return strval($qualityValue)."wq.png";
    ...
    <p class="col s12" style="color:#165a90; padding-left:90px">Set IP Address Manually</p>
    </a>
    -->
    ...
    <div class="tab" id="ipsetting">
      ...
      <button class="subtablinks" onclick="openSubTab(event, 'static')">Static IP</button>
    </div>
...
<!--</form>-->
<script src="settings_byAli.js"></script>
